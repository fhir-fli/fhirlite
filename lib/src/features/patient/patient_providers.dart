...
class ActivePatient extends _$ActivePatient {
  ...
  /// TODO: consider including other ValueSets - for import anyway, should
  /// continue to use our ValueSet for new values
  ...
  /// TODO: decide if we want to use UScore's race, ethnicity and Tribal Identity
  /// or if we should make our own with a wider ValueSet
